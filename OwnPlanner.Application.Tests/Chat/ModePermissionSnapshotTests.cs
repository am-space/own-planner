...
{
	// Frozen from merged d704568 before #59, with explicit Week Planning additions for #62.
	// Do not derive expected permissions from production groups.
